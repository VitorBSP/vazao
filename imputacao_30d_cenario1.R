...
df$kalman_struct = imputeTS::na_kalman(df$Vazao1_CA_30d, model = 'StructTS')
df$kalman_arima = imputeTS::na_kalman(df$Vazao1_CA_30d, model ='auto.arima')
...
nulos <- which(is.na(df$Vazao1_CA_30d), arr.ind = TRUE)
