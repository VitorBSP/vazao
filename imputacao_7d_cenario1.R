...
df$kalman_struct = imputeTS::na_kalman(df$Vazao1_CA_7d, model = 'StructTS')
df$kalman_arima = imputeTS::na_kalman(df$Vazao1_CA_7d, model ='auto.arima')
...
nulos <- which(is.na(df$Vazao1_CA_7d), arr.ind = TRUE)
