...
df$kalman_struct = imputeTS::na_kalman(df$Vazao1_CA_1d, model = 'StructTS')
df$kalman_arima = imputeTS::na_kalman(df$Vazao1_CA_1d, model ='auto.arima')
...
nulos <- which(is.na(df$Vazao1_CA_1d), arr.ind = TRUE)
